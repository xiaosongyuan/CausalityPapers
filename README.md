...
**Knowledge Enhanced Event Causality Identification with Mention Masking Generalizations.** Jian Liu, Yubo Chen and Jun Zhao, 2020. **Proceedings of the Twenty-Ninth International Joint Conference on Artificial Intelligence (IJCAI-20).** [[paper]](https://www.ijcai.org/Proceedings/2020/0499.pdf)
...
**Joint Extraction of Entities and Relations Based on a Novel Tagging Scheme.** Suncong Zheng, Feng Wang, Hongyun Bao, Yuexing Hao,Peng Zhou and Bo Xu, 2017. **Proceedings of the 55th Annual Meeting of the Association for Computational Linguistics, pages 1227–1236, Vancouver, Canada, July 30 - August 4, 2017.** [[paper]](https://www.aclweb.org/anthology/P17-1113.pdf) [[code]](https://github.com/gswycf/Joint-Extraction-of-Entities-and-Relations-Based-on-a-Novel-Tagging-Scheme)

**Going out on a limb: Joint Extraction of Entity Mentions and Relations without Dependency Trees.** Arzoo Katiyar and Claire Cardie, 2017. **Proceedings of the 55th Annual Meeting of the Association for Computational Linguistics, pages 917–928, Vancouver, Canada, July 30 - August 4, 2017.** [[paper]](https://www.aclweb.org/anthology/P17-1085.pdf) [[code]](https://github.com/Luka0612/JEAR)
...
**Global Normalization of Convolutional Neural Networks for Joint Entity and Relation Classification.** Heike Adel and Hinrich Schutze, 2017. **Proceedings of the 2017 Conference on Empirical Methods in Natural Language Processing, pages 1723–1729, Copenhagen, Denmark, September 7–11, 2017.** [[paper]](https://www.aclweb.org/anthology/D17-1181.pdf) [[code]](https://github.com/heikeadel/global_normalization)

**Joint entity recognition and relation extraction as a multi-head selection problem.** Giannis Bekoulis, Johannes Deleu, Thomas Demeester and Chris Develder, 2018. **Expert Systems with Applications, Volume 114, 30 December 2018, Pages 34-45.** [[paper]](https://www.sciencedirect.com/science/article/abs/pii/S095741741830455X) [[code]](https://github.com/bekou/multihead_joint_entity_relation_extraction)
...
## CE papers(sentence-level)

**Attention Guided Graph Convolutional Networks for Relation Extraction.** Zhijiang Guo, Yan Zhang and Wei Lu, 2019. **roceedings of the 57th Annual Meeting of the Association for Computational Linguistics, pages 241–251, Florence, Italy, July 28 - August 2, 2019.** [[paper]](https://www.aclweb.org/anthology/P19-1024.pdf) [[code]](https://github.com/Cartus/AGGCN)
...
**Counterfactual Data-Fusion for Online Reinforcement Learners.** Andrew Forney, Judea Pearl and Elias Bareinboim, 2017. **Proceedings of the 34 th International Conference on Machine Learning, Sydney, Australia, PMLR 70, 2017.** [[paper]](http://proceedings.mlr.press/v70/forney17a/forney17a.pdf)

**Causal Effect Inference with Deep Latent-Variable Models.** Christos Louizos, Uri Shalit, Joris Mooij, David Sontag, Richard Zemel and Max Welling, 2017. **31st Conference on Neural Information Processing Systems (NIPS 2017), Long Beach, CA, USA.** [[paper]](http://ml-dev.mit.edu/sites/default/files/publications/1705.08821.pdf)

**Causal Effect Estimation and Optimal Dose Suggestions in Mobile Health International Conference on Machine Learning.** Liangyu Zhu, Wenbin Lu and Rui Song, 2020. **Proceedings of the 37th International Conference on Machine Learning, PMLR 119:11588-11598, 2020.** [[paper]](http://proceedings.mlr.press/v119/zhu20c/zhu20c.pdf)

**Counterfactual Cross-Validation: Stable Model Selection Procedure for Causal Inference Models.** Yuta Saito and Shota Yasui, 2020. **Proceedings of the 37th International Conference on Machine Learning, PMLR 119:8398-8407, 2020.** [[paper]](http://proceedings.mlr.press/v119/saito20a/saito20a.pdf) [[code]](https://github.com/usaito/counterfactual-cv)

**Discovering Fully Oriented Causal Networks.** Osman Mian, Alexander Marx and Jilles Vreeken, 2021. **AAAI 2021** [[paper]](http://eda.mmci.uni-saarland.de/pubs/2021/globe-mian,marx,vreeken-wapx.pdf)

**Improving the accuracy of medical diagnosis with causal machine learning.** Jonathan G. Richens, Ciarán M. Lee and Saurabh Johri, 2020. **Nature Communications volume 11, Article number: 3923 (2020).** [[paper]](https://www.nature.com/articles/s41467-020-17419-7.pdf)
